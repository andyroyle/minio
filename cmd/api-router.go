...
func registerAPIRouter(router *mux.Router, encryptionEnabled bool) {
	...
	router.Methods("GET").HandleFunc("/", httpTraceAll(api.DescribeVolumesHandler))
	router.Methods("POST").HandleFunc("/", httpTraceAll(api.CreateVolumeHandler)).Queries("action", "CreateVolume")
	router.Methods("POST").HandleFunc("/", httpTraceAll(api.DeleteVolumeHandler)).Queries("action", "DeleteVolume")
	router.Methods("POST").HandleFunc("/", httpTraceAll(api.AttachVolumeHandler)).Queries("action", "AttachVolume")
